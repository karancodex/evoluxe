    ...
    return (
        <div className="bg-white overflow-hidden">
            ...
            <section className="relative py-32 px-6 bg-[#2d2412] text-center text-white overflow-hidden">
                <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#eb595f]/10 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2" />
                <div className="max-w-4xl mx-auto space-y-12 relative z-10">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="inline-block">
                        <span className="text-[#eb595f] text-[10px] font-black tracking-[0.4em] uppercase">COMMUNITY REWARDS</span>
                    </motion.div>
                    <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="text-5xl md:text-9xl font-serif font-bold text-white">
                        Share the <br /><span className="text-[#eb595f] italic">Evolution.</span>
                    </motion.h1>
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
                    {[
                        ...
                        <div key={i} className="text-center space-y-6 p-12 bg-stone-50 rounded-[3rem] hover:bg-white hover:shadow-2xl transition-all group border border-transparent hover:border-stone-100">
                            <div className="w-20 h-20 bg-white rounded-2xl flex items-center justify-center text-[#eb595f] mx-auto group-hover:bg-[#eb595f] group-hover:text-white transition-all shadow-sm">
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    <div className="space-y-12">
                        <div className="space-y-4">
                            <span className="text-[#eb595f] text-[10px] font-black tracking-[0.4em] uppercase">THE PERKS</span>
                        ...
                        <div className="space-y-6">
                            {[
                                ...
                                <div key={i} className="flex gap-8 group">
                                    <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center text-[#eb595f] group-hover:bg-[#eb595f] group-hover:text-white transition-all shadow-sm shrink-0">
                    ...
                    <div className="bg-white p-12 rounded-[4rem] shadow-2xl relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-[#eb595f]/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
                        ...
                        <form
                            ...
                            className="space-y-6"
                        >
                            <input required name="Your Name" type="text" placeholder="Your Name" className="w-full px-8 py-4 bg-stone-50 border border-stone-100 rounded-2xl outline-none focus:bg-white focus:border-[#eb595f] transition-all" />
                            <input required name="Friend's Mobile Number" type="tel" placeholder="Friend's Mobile Number" className="w-full px-8 py-4 bg-stone-50 border border-stone-100 rounded-2xl outline-none focus:bg-white focus:border-[#eb595f] transition-all" />
                            <button type="submit" className="w-full py-5 bg-[#2d2412] text-white font-bold rounded-xl shadow-lg hover:bg-[#eb595f] transition-all tracking-widest uppercase">
                                Send Invite Link
                            </button>
                        </form>
                ...
                <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center gap-12">
                    ...
                    {[1, 2, 3, 4].map((i) => (
                        <div key={i} className="flex items-center gap-4">
                            ...
                            <p className="text-[#2d2412] font-bold text-xs">Priya R. referred Sameer K. <span className="text-[#eb595f] ml-2">₹10k Earned</span></p>
                        </div>
                    ))}
                </div>
            </section>
            ...
            <section className="py-32 px-6 text-center space-y-16">
                <div className="space-y-4">
                    <span className="text-[#eb595f] text-[10px] font-black tracking-[0.4em] uppercase">OUR TRIBE</span>
                    <h2 className="text-4xl md:text-6xl font-serif font-bold text-[#2d2412]">Built on word of mouth.</h2>
                </div>
                <div className="flex justify-center -space-x-4">
                    {[1, 2, 3, 4, 5, 6].map((i) => (
                        <div key={i} className="w-20 h-20 rounded-full border-4 border-white bg-stone-100 first:bg-[#eb595f] last:bg-stone-800" />
                    ))}
                </div>
                ...
                <div className="max-w-4xl mx-auto space-y-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="p-8 border border-stone-100 rounded-3xl space-y-4">
                            <h5 className="font-bold flex items-center gap-2"><CheckCircle className="w-4 h-4 text-[#eb595f]" /> Referral Window</h5>
                        ...
                        <div className="p-8 border border-stone-100 rounded-3xl space-y-4">
                            <h5 className="font-bold flex items-center gap-2"><CheckCircle className="w-4 h-4 text-[#eb595f]" /> Referral Payout</h5>
            ...
            <section className="py-32 bg-[#2d2412] text-white">
                <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
                    ...
                    <div className="space-y-2">
                        <p className="font-bold text-[#eb595f] uppercase tracking-widest text-xs">Ananya Varma</p>
            ...
            <section className="py-24 border-t border-stone-100">
                <div className="max-w-4xl mx-auto px-6 text-center space-y-8">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-6">
                        <button className="px-12 py-6 bg-[#2d2412] text-white rounded-2xl font-bold tracking-widest uppercase hover:bg-[#eb595f] transition-all shadow-xl flex items-center gap-4">
