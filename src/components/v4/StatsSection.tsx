    ...
    return (
        <section className="py-24 bg-white relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none opacity-20">
                <div className="absolute top-20 left-10 w-64 h-64 bg-[#e5d5b0] rounded-full blur-[100px]" />
                <div className="absolute bottom-20 right-10 w-96 h-96 bg-[#c5a059] rounded-full blur-[150px]" />
            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="text-center mb-20">
                    ...
                    <motion.h2
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        className="text-4xl md:text-5xl font-bold text-[#4d3b1a] mb-6"
                    >
                        Built on Trust, Crafted with <span className="text-[#c5a059]">Precision</span>
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        className="text-[#4d3b1a]/70 max-w-xl mx-auto text-lg leading-relaxed"
                    >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {stats.map((stat, index) => (
                        ...
                        >
                            ...
                            <div className="absolute -right-4 -top-4 w-24 h-24 bg-[#faf9f6]/50 rounded-full group-hover:bg-[#c5a059]/10 transition-colors duration-500 -z-0" />

                            <div className="relative z-10">
                                <div className="w-16 h-16 bg-[#faf9f6] rounded-2xl flex items-center justify-center text-[#c5a059] mb-8 group-hover:bg-[#c5a059] group-hover:text-white transition-all duration-300 transform group-hover:rotate-6 shadow-sm">
                                    {stat.icon}
                                </div>
                                <div className="space-y-2">
                                    <h3 className="text-3xl font-bold text-[#4d3b1a] group-hover:text-[#c5a059] transition-colors tracking-tight">
                                        {stat.value}
                                    </h3>
                                    <p className="text-[#4d3b1a]/60 font-medium group-hover:text-[#4d3b1a] transition-colors leading-snug">
                                        {stat.label}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="absolute bottom-6 right-8 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-4 group-hover:translate-x-0">
                                <svg className="w-6 h-6 text-[#c5a059]/30" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <motion.div
                    ...
                    whileInView={{ opacity: 1, y: 0 }}
                    className="mt-20 p-10 bg-[#4d3b1a] rounded-[3rem] text-center relative overflow-hidden shadow-2xl"
                >
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
                        ...
                        <div className="flex gap-4">
                            <button className="px-8 py-4 bg-[#e5d5b0] text-[#4d3b1a] font-bold rounded-full hover:bg-white transition-all transform hover:scale-105 active:scale-95 shadow-lg">
                                Consult a Designer
                            </button>
