        ...
        <section className="py-24 bg-white">
            <div className="max-w-[1800px] mx-auto px-6">
                <div className="text-center mb-20">
                    ...
                    <h2 className="text-5xl md:text-6xl font-serif text-[#4d3b1a]">Loved by Homeowners</h2>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {reviews.map((review, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="bg-white rounded-[2rem] overflow-hidden border border-neutral-200 hover:border-[#4d3b1a] hover:shadow-2xl transition-all duration-300 flex flex-col h-full group"
                        >
                            ...
                            <div className="relative h-64 w-full overflow-hidden bg-gray-100">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center z-10 bg-black/10 group-hover:bg-black/20 transition-colors">
                                    <div className="w-14 h-14 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center cursor-pointer shadow-lg group-hover:scale-110 transition-transform duration-300">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-[#4d3b1a] ml-0.5">
                            ...
                            <div className="p-8 flex-1 flex flex-col">
                                ...
                                <div className="mb-6 border-b border-neutral-100 pb-4">
                                    <h3 className="text-[#4d3b1a] font-serif text-xl font-bold mb-1">{review.name}</h3>
