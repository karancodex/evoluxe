                        ...
                        <div className="bg-[#4d3b1a] text-white p-6 sm:p-12 rounded-[2rem] sm:rounded-[4rem] relative overflow-hidden shadow-2xl">
                            ...
                            <div className="space-y-8 relative z-10">
                                <div className="flex items-start gap-6">
                                    <div className="w-12 h-12 bg-white/10 rounded-2xl flex items-center justify-center text-[#e5d5b0] shrink-0">
                    ...
                    <div className="bg-stone-50 p-6 sm:p-12 rounded-[2rem] sm:rounded-[3rem] border border-stone-100">
                        ...
                        <form className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea rows={4} className="w-full px-6 py-4 bg-white border border-stone-200 rounded-2xl outline-none focus:border-[#c5a059] transition-all resize-none" placeholder="How can we help you today?" />
                            </div>
                            <button className="w-full py-5 bg-[#c5a059] text-white font-bold rounded-2xl shadow-xl hover:bg-[#4d3b1a] transition-all duration-300 flex items-center justify-center gap-3">
