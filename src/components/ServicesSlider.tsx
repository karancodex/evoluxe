...
const servicesList = [
    { title: "Modular Kitchen", image: "/v4/luxury_kitchen_2.png", price: "Starts ₹1.2L*", size: "large", desc: "Italian finishes & German hardware", slug: "modular-kitchen" },
    { title: "Modular Wardrobes", image: "/v4/service_wardrobe.png", price: "Starts ₹80k*", size: "medium", desc: "Walk-in & sliding solutions", slug: "modular-wardrobes" },
    { title: "Customized Furniture", image: "/v4/luxury_living_1.png", price: "Starts ₹55k*", size: "medium", desc: "TV units & accent walls", slug: "customized-furniture" },
    { title: "Electrical Work", image: "/v4/3d_electrical_iso.png", price: "Starts ₹45k*", size: "medium", desc: "Smart & safe solutions", slug: "electrical-work" },
    { title: "False Ceiling", image: "/v4/hero-bg.png", price: "Starts ₹15k*", size: "small", desc: "Ambient & cove lighting", slug: "false-ceiling" },
    { title: "Plumbing", image: "/v4/luxury_bathroom_1.png", price: "Starts ₹25k*", size: "small", desc: "Seamless engineering", slug: "plumbing" },
    { title: "Civil Work", image: "/v4/luxury_office_3.png", price: "Starts ₹35k*", size: "small", desc: "Foundations of luxury", slug: "civil-work" },
    { title: "Painting", image: "/v4/painting.png", price: "Starts ₹30k*", size: "small", desc: "Chromatic perfection", slug: "painting" },
    { title: "Flooring", image: "/v4/luxury_office_2.png", price: "Starts ₹65k*", size: "small", desc: "Surface elegance", slug: "floorings-wall-design" }
];
