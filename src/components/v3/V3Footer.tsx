                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-24 mb-32">
                    ...
                    <div className="lg:col-span-1 space-y-10">
                        <Link href="/v3" className="flex items-center gap-4 group">
                            <div className="w-12 h-12 bg-amethyst-primary flex items-center justify-center rounded-xl shadow-2xl">
                        ...
                        <p className="text-amethyst-lightest/40 text-[10px] uppercase tracking-widest leading-loose font-black italic max-w-xs">
                        ...
                        <div className="flex gap-6">
                            {["Instagram", "LinkedIn", "Houzz"].map(social => (
                                <span key={social} className="text-white text-[9px] uppercase tracking-widest font-black border-b border-amethyst-primary pb-1 cursor-pointer hover:border-white transition-all">
                                    {social}
                                </span>
                            ))}
                        </div>
                    ...
                    <div className="space-y-10">
                        <span className="text-amethyst-primary text-[11px] uppercase tracking-[0.8em] font-black italic">Collections</span>
                    ...
                    {/* Newsletter / Contact */}
                    <div className="space-y-10">
                        <span className="text-amethyst-primary text-[11px] uppercase tracking-[0.8em] font-black italic">Concierge Contact</span>
                        <div className="space-y-8">
                            <div className="space-y-2">
                                <p className="text-white text-lg font-serif italic">+91 40 2345 6789</p>
                                <p className="text-amethyst-lightest/20 text-[9px] uppercase tracking-widest font-black">Available 10 AM — 8 PM IST</p>
                            </div>
                            <div className="space-y-4">
                                <p className="text-amethyst-lightest/40 text-[10px] uppercase tracking-widest font-black leading-relaxed">
                                    Level 4, Signature Towers,<br />
                                    Shaikpet, Hyderabad, India.
                                </p>
                            </div>
                            <div className="pt-2">
                                <button className="w-full bg-amethyst-primary/10 border border-amethyst-primary/30 text-amethyst-primary py-4 rounded-xl text-[10px] uppercase tracking-widest font-black hover:bg-amethyst-primary hover:text-white transition-all">
