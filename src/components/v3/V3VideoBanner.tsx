...
const V3VideoBanner = () => {
    return (
        <section className="py-20 bg-amethyst-lightest overflow-hidden">
                ...
                >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-amethyst-dark/80 via-transparent to-transparent flex flex-col items-center justify-center text-center p-12">
                        <div className="w-24 h-24 rounded-full bg-white/20 backdrop-blur-xl border border-white/30 flex items-center justify-center mb-8 cursor-pointer hover:scale-110 transition-transform group">
                            <span className="text-white text-3xl transform translate-x-1 group-hover:text-amethyst-light transition-colors">▶</span>
                        </div>
                        ...
                        <p className="text-amethyst-lightest/60 text-lg uppercase tracking-widest font-black max-w-xl">See the technical brilliance and royal finishes in a 360° walkthrough</p>
                    </div>
                </motion.div>
            </div>
        </section>
