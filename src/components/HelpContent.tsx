...
const HelpContent = () => {
    ...
    return (
        <div className="bg-white overflow-hidden">
            {/* 1. HERO SECTION */}
            <section className="relative py-32 px-6 bg-[#eb595f] text-white overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto text-center space-y-12 relative z-10">
                    <div className="space-y-4">
                        <span className="text-white text-[10px] font-black tracking-[0.4em] uppercase drop-shadow-sm">HELP CENTER</span>
                        <h1 className="text-5xl md:text-8xl font-serif font-bold leading-tight drop-shadow-sm">How can we help <br /> you today?</h1>
                    </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-4 text-xs font-bold uppercase tracking-widest text-white/90">
                        <span>Popular:</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {popularTopics.map((item, i) => (
                            <div key={i} className="bg-stone-50 p-12 rounded-[3rem] space-y-8 hover:bg-white hover:shadow-2xl hover:scale-105 transition-all duration-500 border border-transparent hover:border-stone-100 group">
                                ...
                                <button className="flex items-center gap-2 text-[#eb595f] font-black text-[10px] uppercase tracking-widest group-hover:gap-4 transition-all">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        <div className="space-y-12">
                            <div className="space-y-4">
                                <span className="text-[#eb595f] text-[10px] font-black tracking-[0.4em] uppercase">TRANSPARENCY FIRST</span>
                            ...
                            <div className="space-y-8">
                                {[
                                    ...
                                    <div key={i} className="flex gap-8 group">
                                        <span className="text-4xl font-serif font-bold text-stone-200 group-hover:text-[#eb595f] transition-colors">{step.step}</span>
                        ...
                        <div className="bg-white p-12 rounded-[4rem] shadow-2xl relative overflow-hidden">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-[#eb595f]/5 rounded-full -translate-y-1/2 translate-x-1/2" />
                            ...
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <div className="h-4 bg-stone-100 rounded-full overflow-hidden">
                                        <div className="h-full bg-[#eb595f] w-[65%]" />
                                    </div>
                                </div>
                                ...
                                <button className="w-full py-5 bg-[#eb595f] text-white rounded-xl font-bold text-xs tracking-widest uppercase hover:bg-[#2d2412] transition-all">
                                    Log in to Tracker
                                </button>
                            </div>
                        </div>
            ...
            <section className="py-32 px-6">
                <div className="max-w-7xl mx-auto bg-[#faf9f6] rounded-[4rem] p-12 md:p-24 border border-stone-100 relative overflow-hidden">
                    <ShieldCheck className="w-64 h-64 text-[#eb595f]/5 absolute -right-20 -bottom-20 rotate-12" />
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-2 gap-8">
                                <div className="space-y-2">
                                    ...
                                    <p className="text-xs font-bold uppercase tracking-widest text-[#eb595f]">Full Warranty</p>
                                </div>
                                <div className="space-y-2">
                                    <p className="text-3xl font-serif font-bold text-[#2d2412]">48 Hrs</p>
                                    <p className="text-xs font-bold uppercase tracking-widest text-[#eb595f]">Support Response</p>
                                </div>
                            </div>
                        </div>
                        <div className="space-y-8 flex flex-col justify-center">
                            {["Hardware (Blum/Hettich)", "Marine Grade Plywood", "Color & Finish Continuity"].map((item, i) => (
                                <div key={i} className="flex items-center gap-6 p-6 bg-white rounded-3xl shadow-sm border border-stone-100">
                                    <div className="w-12 h-12 bg-[#eb595f]/10 rounded-xl flex items-center justify-center text-[#eb595f]">
                        ...
                        {faqs.map((faq, i) => (
                            <div key={i} className="p-8 bg-white border border-stone-100 rounded-[2.5rem] space-y-4 hover:shadow-xl transition-all cursor-pointer group">
                                <div className="flex justify-between items-center">
                                    <h4 className="text-2xl font-serif font-bold text-[#2d2412] group-hover:text-[#eb595f] transition-colors">{faq.q}</h4>
                                    <div className="w-10 h-10 rounded-full bg-stone-50 flex items-center justify-center group-hover:bg-[#eb595f] group-hover:text-white transition-all text-stone-400">
                                        +
                                    </div>
                                </div>
            ...
            <section className="py-32 bg-[#eb595f] text-white">
                <div className="max-w-7xl mx-auto px-6 text-center space-y-12">
                    <h2 className="text-4xl md:text-6xl font-serif font-bold drop-shadow-sm">Maintenance Guides.</h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="bg-white/10 p-10 rounded-[3rem] border border-white/20 hover:bg-white/20 transition-all cursor-pointer group shadow-lg">
                                <div className="mb-6 flex justify-center text-white group-hover:scale-110 transition-transform">
                                    {React.cloneElement(item.icon as React.ReactElement<any>, { className: "w-12 h-12 drop-shadow-sm" })}
                                </div>
                                <h3 className="text-xl font-serif font-bold mb-4 drop-shadow-sm">{item.title}</h3>
                                <p className="text-white/80 text-sm font-light group-hover:text-white">Download the PDF guide for pro maintenance tips.</p>
                            </div>
                        ))}
                    </div>
                </div>
